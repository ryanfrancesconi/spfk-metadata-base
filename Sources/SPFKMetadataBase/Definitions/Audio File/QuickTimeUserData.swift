...
/// AVFoundation (`AVMetadataItem`) rather than TagLib. Read-only — this data isn't editable
/// through this app. Populated by `spfk-metadata`'s AVFoundation-based reader; `nil` for files
/// with no QuickTime user-data (including most pure-audio files). See `shadowtag-video-metadata-plan.md`.
