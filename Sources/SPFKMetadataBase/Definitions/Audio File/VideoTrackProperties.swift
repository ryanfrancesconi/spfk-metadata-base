...
/// stream-technical facts, not tags. Populated by `spfk-metadata`'s AVFoundation-based
/// reader; `nil` for pure-audio files. See `shadowtag-video-metadata-plan.md`.
public struct VideoTrackProperties: Hashable, Sendable, Codable {
    ...
    /// video needs applied to preview right-side-up — see `VideoLayerView`.
